...
import { Anexo006A17Service } from 'src/app/core/services/anexos/anexo006-a17.service';
import { AnexoResponse } from 'src/app/core/models/Anexos/Anexo006_A17/AnexoResponse';
import { AnexoRequestPost } from 'src/app/core/models/Anexos/Anexo006_A17/AnexoRequestPost';
import { Seccion1, Seccion2, Seccion3, Seccion4 } from 'src/app/core/models/Anexos/Anexo006_A17/Secciones';
...
import { DropdownService } from 'src/app/core/models/Anexos/Anexo006_A17/dropdown.service';
...
@Component({
  selector: 'app-anexo006-a17',
  templateUrl: './anexo006-a17.component.html',
  styleUrls: ['./anexo006-a17.component.css'],
  providers: [
...
export class Anexo006A17Component implements OnInit {
...
disabledAcordion: number = 2;
  ...
  constructor( public fb:UntypedFormBuilder,
    ...
    private formularioService: Anexo006A17Service,
  ...
  this.visorPdfArchivosService.get(this.uriArchivo) 
    .subscribe(
      (file: Blob) => {
        ...
        modalRef.componentInstance.titleModal = "Vista Previa - Anexo 006-A/17";
      },
      error => {
        this.funcionesMtcService
          .ocultarCargando()
