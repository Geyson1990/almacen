...
import { Formulario005_17_3Service } from '../../../application/usecases';
...
export class FormularioComponent implements OnInit, AfterViewInit {
   ...
   txtTituloCompleto: string = "FORMULARIO 005/17.03 TALLER DE CONVERSION A GAS NATURAL VEHICULAR - GNV O TALLER DE CONVERSIÓN A GAS LICUADO DE PETROLEO - GLP";
   ...
   //Datos de Formulario
   tituloFormulario = "FORMULARIO 005/17.03 TALLER DE CONVERSION A GAS NATURAL VEHICULAR - GNV O TALLER DE CONVERSIÓN A GAS LICUADO DE PETROLEO - GLP";
   ...
   seccionDatosEmpresa: string[] = ["DCV-015", "DCV-016","DCV-017","DCV-018"];
   activarDatosEmpresa: boolean = true;

   paDJ3: string[] = ["DCV-015","DCV-016","DCV-017","DCV-018"];
   paDJ7: string[] = ["DCV-018"];
   paDJ8: string[] = ["DCV-016"];
   ...
   constructor(
      ...
      private formularioService: Formulario005_17_3Service,
      ...
      this.formulario = this.fb.group({
         ...
         Seccion3: this.fb.group({
            f_s3_datosEmpresa: this.fb.group({
               ...
               f_s3_de_fechaResolucionGases:(this.activarDatosEmpresa ? this.fb.control('', [Validators.required, Validators.maxLength(100)]) : this.fb.control(null))
            }),
         ...
         declaracion_7: (this.codigoProcedimientoTupa == "DCV-016" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_8: (this.codigoProcedimientoTupa == "DCV-018" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      });
   }
   ...
   get f_declaracion_7(): AbstractControl { return this.formulario.get(['declaracion_7']); }
   get f_declaracion_8(): AbstractControl { return this.formulario.get(['declaracion_8']); }
   ...
   async cargarDatos(): Promise<void> {
      ...
      if (this.dataInput != null && this.dataInput.movId > 0) {
         try {
            ...
            const dataFormulario = await this.formularioTramiteService.get<Formulario005_17_3Response>(this.dataInput.tramiteReqId).toPromise();
            this.funcionesMtcService.ocultarCargando();
            ...
            this.f_declaracion_7.setValue(metaData.seccion4.dcv_018_dj_1);
            this.f_declaracion_8.setValue(metaData.seccion4.dcv_016_dj_1);

            this.f_s3_de_partida.setValue(metaData.seccion5.partidaRegistral);
            this.f_s3_de_asiento.setValue(metaData.seccion5.asiento);
            this.f_s3_de_resolucionGases.setValue(metaData.seccion5.resolucionGases);

            this.setDateValue(this.f_s3_de_fechaResolucionGases, metaData.seccion5.fechaResolucionGases);

            this.fechaGases = metaData.seccion5.fechaResolucionGases;
            ...
            this.f_declaracion_7.setValue(metaData.seccion5.dcv_016_dj_1);
            this.f_declaracion_8.setValue(metaData.seccion5.dcv_018_dj_1);
         }
         catch (e) {
            console.error(e);
   ...
   guardarFormulario() {
      ...
      let dataGuardar: Formulario005_17_3Request = new Formulario005_17_3Request();

      dataGuardar.id = this.id;
      dataGuardar.codigo = 'F005-17.3';
      ...
      dataGuardar.metaData.seccion5.dcv_016_dj_1  = this.f_declaracion_7.value;
      dataGuardar.metaData.seccion5.dcv_018_dj_1  = this.f_declaracion_8.value;

      dataGuardar.metaData.seccion5.partidaRegistral = this.f_s3_de_partida.value;
      dataGuardar.metaData.seccion5.asiento = this.f_s3_de_asiento.value;
      dataGuardar.metaData.seccion5.resolucionGases = this.f_s3_de_resolucionGases.value;
      dataGuardar.metaData.seccion5.fechaResolucionGases = fechaResolucionGases;
      ...
      this.visorPdfArchivosService.get(this.uriArchivo)
         ...
         .subscribe(
            (file: Blob) => {
               ...
               modalRef.componentInstance.titleModal = "Vista Previa - Formulario 005/17.03";
