...
import { Anexo001_A28Request } from '../../../../../core/models/Anexos/Anexo001_A28/Anexo001_A28Request';
import { FuncionesMtcService } from '../../../../../core/services/funciones-mtc.service';
import { Anexo001A28Service } from '../../../../../core/services/anexos/anexo001-a28.service';
import { A001_A28_Seccion1, A001_A28_Seccion2, Parentesco, Familiar } from '../../../../../core/models/Anexos/Anexo001_A28/Secciones';
...
import { Anexo001_A28Response } from 'src/app/core/models/Anexos/Anexo001_A28/Anexo001_A28Response';
...
@Component({
  selector: 'app-anexo001-a28',
  templateUrl: './anexo001-a28.component.html',
  styleUrls: ['./anexo001-a28.component.css']
})
export class Anexo001A28Component implements OnInit {  
  ...
  constructor(
    ...
    private anexoService: Anexo001A28Service,
  ...
  recuperarInformacion(){
    ...
    if (this.dataInput.movId > 0 && this.dataInput.completo === false) {
        ...
        this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
          (dataAnexo: Anexo001_A28Response) => {
  ...
  save(){
    const dataGuardar: Anexo001_A28Request = new Anexo001_A28Request();
    //-------------------------------------
    ...
    let seccion1: A001_A28_Seccion1 = new A001_A28_Seccion1();
    ...
    let seccion2: A001_A28_Seccion2 = new A001_A28_Seccion2();
