...
import { Anexo001_B28Request } from '../../../../../core/models/Anexos/Anexo001_B28/Anexo001_B28Request';
import { FuncionesMtcService } from '../../../../../core/services/funciones-mtc.service';
import { Anexo001B28Service } from '../../../../../core/services/anexos/anexo001-b28.service';
import { A001_B28_Seccion1, A001_B28_Seccion2, Parentesco, Familiar } from '../../../../../core/models/Anexos/Anexo001_B28/Secciones';
...
import { Anexo001_B28Response } from 'src/app/core/models/Anexos/Anexo001_B28/Anexo001_B28Response';
...
@Component({
  selector: 'app-anexo001-b28',
  templateUrl: './anexo001-b28.component.html',
  styleUrls: ['./anexo001-b28.component.css']
})
export class Anexo001B28Component implements OnInit {  
  ...
  constructor(
    ...
    private anexoService: Anexo001B28Service,
  ...
  recuperarInformacion(){
    ...
    if (this.dataInput.movId > 0 && this.dataInput.completo === false) {
        ...
        this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
          (dataAnexo: Anexo001_B28Response) => {
  ...
  save(){
    const dataGuardar: Anexo001_B28Request = new Anexo001_B28Request();
    //-------------------------------------
    ...
    let seccion1: A001_B28_Seccion1 = new A001_B28_Seccion1();
    ...
    let seccion2: A001_B28_Seccion2 = new A001_B28_Seccion2();
