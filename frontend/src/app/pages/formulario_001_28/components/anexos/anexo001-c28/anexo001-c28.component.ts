...
import { Anexo001_C28Request } from '../../../../../core/models/Anexos/Anexo001_C28/Anexo001_C28Request';
import { FuncionesMtcService } from '../../../../../core/services/funciones-mtc.service';
import { Anexo001C28Service } from '../../../../../core/services/anexos/anexo001-c28.service';
import { A001_C28_Seccion1, A001_C28_Seccion2, Parentesco, Familiar } from '../../../../../core/models/Anexos/Anexo001_C28/Secciones';
...
import { Anexo001_C28Response } from 'src/app/core/models/Anexos/Anexo001_C28/Anexo001_C28Response';
...
@Component({
  selector: 'app-anexo001-c28',
  templateUrl: './anexo001-c28.component.html',
  styleUrls: ['./anexo001-c28.component.css']
})
export class Anexo001C28Component implements OnInit {  
  ...
  constructor(
    ...
    private anexoService: Anexo001C28Service,
  ...
  recuperarInformacion(){
    ...
    if (this.dataInput.movId > 0 && this.dataInput.completo === false) {
        ...
        this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
          (dataAnexo: Anexo001_C28Response) => {
  ...
  save(){
    const dataGuardar: Anexo001_C28Request = new Anexo001_C28Request();
    //-------------------------------------
    ...
    let seccion1: A001_C28_Seccion1 = new A001_C28_Seccion1();
    ...
    let seccion2: A001_C28_Seccion2 = new A001_C28_Seccion2();
