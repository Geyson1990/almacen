...
import { Formulario004_17_3Service } from '../../../application/usecases';
...
export class FormularioComponent implements OnInit, AfterViewInit {
   ...
   txtTituloCompleto: string = "FORMULARIO 004/17.03 ENTIDAD CERTIFICADORA DE CONVERSIONES A GAS NATURAL VEHICULAR-GNV O GAS LICUADO DE PETRÓLEO-GLP";
   ...
   //Datos de Formulario
   tituloFormulario = 'ENTIDAD CERTIFICADORA DE CONVERSIONES A GAS NATURAL VEHICULAR-GNV O GAS LICUADO DE PETRÓLEO-GLP';
   ...
   seccion1: string[] = ["DCV-013", "DCV-014"];
   activarSeccion1: boolean = true;

   seccionDatosEmpresa: string[] = ["DCV-011", "DCV-013"];
   activarDatosEmpresa: boolean = true;

   paDJ1: string[] = ["DCV-011", "DCV-012", "DCV-013", "DCV-014"];
   paDJ2: string[] = ["DCV-011", "DCV-012", "DCV-013", "DCV-014"];
   pdDJ3: string[] = ["DCV-013"];
   pdDJ4: string[] = ["DCV-011"];
   pdDJ5: string[] = ["DCV-014"];
   pdDJ6: string[] = ["DCV-012"];
   ...
   constructor(
      ...
      private formularioService: Formulario004_17_3Service,
   ...
   async ngOnInit(): Promise<void> {
      ...
      if (this.seccion1.indexOf(this.codigoProcedimientoTupa) > -1) this.activarSeccion1 = true; else this.activarSeccion1 = false;
      ...
      this.formulario = this.fb.group({
         ...
         Seccion1: this.fb.group({
            f_s1_ambitoGeografico: (this.activarSeccion1 ? this.fb.control('', [Validators.required]) : this.fb.control({ value: '', disabled: true })),
         }),
         ...
         Seccion3: this.fb.group({
            f_s3_datosEmpresa: this.fb.group({
               ...
               f_s3_de_asiento: (this.activarDatosEmpresa ? this.fb.control('', [Validators.required, Validators.maxLength(11)]) : ['']),
               f_s3_de_resolucionGases: (this.activarDatosEmpresa ? this.fb.control('', [Validators.required, Validators.maxLength(100)]) : ['']),
               f_s3_de_resolucionAutorizacion: (this.activarDatosEmpresa ? this.fb.control('', [Validators.required, Validators.maxLength(100)]) : ['']),
               f_s3_de_fechaResolucionGases: (this.activarDatosEmpresa ? this.fb.control('', [Validators.required, Validators.maxLength(10)]) : this.fb.control(null)),
               f_s3_de_fechaResolucionAutorizacion: (this.activarDatosEmpresa ? this.fb.control('', [Validators.required, Validators.maxLength(10)]) : this.fb.control(null))
            }),
         ...
         declaracion_11: (this.codigoProcedimientoTupa == "DCV-013" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_12: (this.codigoProcedimientoTupa == "DCV-013" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_13: (this.codigoProcedimientoTupa == "DCV-013" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_14: (this.codigoProcedimientoTupa == "DCV-013" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_15: (this.codigoProcedimientoTupa == "DCV-013" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_16: (this.codigoProcedimientoTupa == "DCV-013" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_17: (this.codigoProcedimientoTupa == "DCV-013" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_21: (this.codigoProcedimientoTupa == "DCV-011" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_22: (this.codigoProcedimientoTupa == "DCV-011" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_23: (this.codigoProcedimientoTupa == "DCV-011" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_24: (this.codigoProcedimientoTupa == "DCV-011" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_25: (this.codigoProcedimientoTupa == "DCV-011" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_26: (this.codigoProcedimientoTupa == "DCV-011" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_27: (this.codigoProcedimientoTupa == "DCV-011" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_3: (this.codigoProcedimientoTupa == "DCV-014" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
         declaracion_4: (this.codigoProcedimientoTupa == "DCV-012" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      });
   }
   ...
   async ngAfterViewInit(): Promise<void> {
      ...
      if (this.activarSeccion1) {
         this.formulario.controls.Seccion1.get("f_s1_ambitoGeografico").setValidators([Validators.required]);
      }
   ...
   get f_s1_ambitoGeografico(): AbstractControl { return this.f_Seccion1.get(['f_s1_ambitoGeografico']); }
   ...
   get f_declaracion_11(): AbstractControl { return this.formulario.get(['declaracion_11']); }
   get f_declaracion_12(): AbstractControl { return this.formulario.get(['declaracion_12']); }
   get f_declaracion_13(): AbstractControl { return this.formulario.get(['declaracion_13']); }
   get f_declaracion_14(): AbstractControl { return this.formulario.get(['declaracion_14']); }
   get f_declaracion_15(): AbstractControl { return this.formulario.get(['declaracion_15']); }
   get f_declaracion_16(): AbstractControl { return this.formulario.get(['declaracion_16']); }
   get f_declaracion_17(): AbstractControl { return this.formulario.get(['declaracion_17']); }
   get f_declaracion_21(): AbstractControl { return this.formulario.get(['declaracion_21']); }
   get f_declaracion_22(): AbstractControl { return this.formulario.get(['declaracion_22']); }
   get f_declaracion_23(): AbstractControl { return this.formulario.get(['declaracion_23']); }
   get f_declaracion_24(): AbstractControl { return this.formulario.get(['declaracion_24']); }
   get f_declaracion_25(): AbstractControl { return this.formulario.get(['declaracion_25']); }
   get f_declaracion_26(): AbstractControl { return this.formulario.get(['declaracion_26']); }
   get f_declaracion_27(): AbstractControl { return this.formulario.get(['declaracion_27']); }
   ...
   async cargarDatos(): Promise<void> {
      ...
      console.log(this.formulario.controls["Seccion3"]);
      //console.log(this.formulario.controls["f_s3_de_fechaResolucionAutorizacion"].value);
      if (this.dataInput != null && this.dataInput.movId > 0) {
         try {
            ...
            const dataFormulario = await this.formularioTramiteService.get<Formulario004_17_3Response>(this.dataInput.tramiteReqId).toPromise();
            this.funcionesMtcService.ocultarCargando();
            const metaData = JSON.parse(dataFormulario.metaData);
            console.log(metaData);
            this.id = dataFormulario.formularioId;
            this.f_s1_ambitoGeografico.setValue(metaData.seccion1.ambitoGeografico);
            ...
            this.f_declaracion_11.setValue(metaData.seccion4.dcv_013_dj_1);
            this.f_declaracion_12.setValue(metaData.seccion4.dcv_013_dj_2);
            this.f_declaracion_13.setValue(metaData.seccion4.dcv_013_dj_3);
            this.f_declaracion_14.setValue(metaData.seccion4.dcv_013_dj_4);
            this.f_declaracion_15.setValue(metaData.seccion4.dcv_013_dj_5);
            this.f_declaracion_16.setValue(metaData.seccion4.dcv_013_dj_6);
            this.f_declaracion_17.setValue(metaData.seccion4.dcv_013_dj_7);
            this.f_declaracion_21.setValue(metaData.seccion4.dcv_011_dj_1);
            this.f_declaracion_22.setValue(metaData.seccion4.dcv_011_dj_2);
            this.f_declaracion_23.setValue(metaData.seccion4.dcv_011_dj_3);
            this.f_declaracion_24.setValue(metaData.seccion4.dcv_011_dj_4);
            this.f_declaracion_25.setValue(metaData.seccion4.dcv_011_dj_5);
            this.f_declaracion_26.setValue(metaData.seccion4.dcv_011_dj_6);
            this.f_declaracion_27.setValue(metaData.seccion4.dcv_011_dj_7);
            this.f_declaracion_3.setValue(metaData.seccion4.dcv_014_dj_1);
            this.f_declaracion_4.setValue(metaData.seccion4.dcv_012_dj_1);

            this.f_s3_de_partida.setValue(metaData.seccion4.partidaRegistral);
            this.f_s3_de_asiento.setValue(metaData.seccion4.asiento);
            this.f_s3_de_resolucionGases.setValue(metaData.seccion4.resolucionGases);
            this.f_s3_de_resolucionAutorizacion.setValue(metaData.seccion4.resolucionAutorizacion);

            this.setDateValue(this.f_s3_de_fechaResolucionGases, metaData.seccion4.fechaResolucionGases);
            this.setDateValue(this.f_s3_de_fechaResolucionAutorizacion, metaData.seccion4.fechaResolucionAutorizacion);

            this.fechaAutorizacion = metaData.seccion4.fechaResolucionAutorizacion;
            this.fechaGases = metaData.seccion4.fechaResolucionGases;
         }
         catch (e) {
            console.error(e);
   ...
   guardarFormulario() {
      ...
      let fechaResolucionAutorizacion: string = "";
      ...
      if (this.activarDatosEmpresa) {
         fechaResolucionGases = (String(this.f_s3_de_fechaResolucionGases.value.day).length > 1 ? this.f_s3_de_fechaResolucionGases.value.day : "0" + this.f_s3_de_fechaResolucionGases.value.day) + "/" + (String(this.f_s3_de_fechaResolucionGases.value.month).length > 1 ? this.f_s3_de_fechaResolucionGases.value.month : "0" + this.f_s3_de_fechaResolucionGases.value.month) + "/" + this.f_s3_de_fechaResolucionGases.value.year;
         fechaResolucionAutorizacion = (String(this.f_s3_de_fechaResolucionAutorizacion.value.day).length > 1 ? this.f_s3_de_fechaResolucionAutorizacion.value.day : "0" + this.f_s3_de_fechaResolucionAutorizacion.value.day) + "/" + (String(this.f_s3_de_fechaResolucionAutorizacion.value.month).length > 1 ? this.f_s3_de_fechaResolucionAutorizacion.value.month : "0" + this.f_s3_de_fechaResolucionAutorizacion.value.month) + "/" + this.f_s3_de_fechaResolucionAutorizacion.value.year;
         console.log(fechaResolucionGases);
      }

      let dataGuardar: Formulario004_17_3Request = new Formulario004_17_3Request();

      dataGuardar.id = this.id;
      dataGuardar.codigo = 'F004-17.3';
      ...
      dataGuardar.metaData.seccion1.ambitoGeografico = this.f_s1_ambitoGeografico.value;
      ...
      dataGuardar.metaData.seccion4.dcv_013_dj_1 = this.f_declaracion_11.value;
      dataGuardar.metaData.seccion4.dcv_013_dj_2 = this.f_declaracion_12.value;
      dataGuardar.metaData.seccion4.dcv_013_dj_3 = this.f_declaracion_13.value;
      dataGuardar.metaData.seccion4.dcv_013_dj_4 = this.f_declaracion_14.value;
      dataGuardar.metaData.seccion4.dcv_013_dj_5 = this.f_declaracion_15.value;
      dataGuardar.metaData.seccion4.dcv_013_dj_6 = this.f_declaracion_16.value;
      dataGuardar.metaData.seccion4.dcv_013_dj_7 = this.f_declaracion_17.value;

      dataGuardar.metaData.seccion4.dcv_011_dj_1 = this.f_declaracion_21.value;
      dataGuardar.metaData.seccion4.dcv_011_dj_2 = this.f_declaracion_22.value;
      dataGuardar.metaData.seccion4.dcv_011_dj_3 = this.f_declaracion_23.value;
      dataGuardar.metaData.seccion4.dcv_011_dj_4 = this.f_declaracion_24.value;
      dataGuardar.metaData.seccion4.dcv_011_dj_5 = this.f_declaracion_25.value;
      dataGuardar.metaData.seccion4.dcv_011_dj_6 = this.f_declaracion_26.value;
      dataGuardar.metaData.seccion4.dcv_011_dj_7 = this.f_declaracion_27.value;

      dataGuardar.metaData.seccion4.dcv_012_dj_1 = this.f_declaracion_4.value;
      dataGuardar.metaData.seccion4.dcv_014_dj_1 = this.f_declaracion_3.value;

      dataGuardar.metaData.seccion4.partidaRegistral = this.f_s3_de_partida.value;
      dataGuardar.metaData.seccion4.asiento = this.f_s3_de_asiento.value;
      dataGuardar.metaData.seccion4.resolucionGases = this.f_s3_de_resolucionGases.value;
      dataGuardar.metaData.seccion4.fechaResolucionGases = fechaResolucionGases;
      dataGuardar.metaData.seccion4.resolucionAutorizacion = this.f_s3_de_resolucionAutorizacion.value;
      dataGuardar.metaData.seccion4.fechaResolucionAutorizacion = fechaResolucionAutorizacion;
      ...
      this.visorPdfArchivosService.get(this.uriArchivo)
         ...
         .subscribe(
            (file: Blob) => {
               ...
               modalRef.componentInstance.titleModal = "Vista Previa - Formulario 004/17.03";
