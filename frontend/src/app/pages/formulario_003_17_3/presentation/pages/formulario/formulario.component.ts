/**
 * Formulario 003/17.03 utilizado por los procedimientos DCV-007, DCV-008, DCV-009 y DCV-010
...
import { Formulario003_17_3Service } from '../../../application/usecases';
...
export class FormularioComponent implements OnInit, AfterViewInit {
  ...
  txtTituloCompleto: string = "FORMULARIO 003/17.03 AUTORIZACIÓN DE ENTIDAD CERTIFICADORA PARA EMITIR LOS CERTIFICADOS DE CONFORMIDAD DE VEHÍCULOS Y AUTORIZACIÓN COMO ENTIDAD CERTIFICADORA DE VEHÍCULOS DE COLECCIÓN";
  ...
  constructor(
    ...
    private formularioService: Formulario003_17_3Service,
    ...
    this.formulario = this.fb.group({
      ...
      Seccion3: this.fb.group({
        ...
        RepresentanteLegal: this.fb.group({
          ...
          rl_apeMaterno: ['', [Validators.maxLength(30)]],
      ...
      declaracion_71: (this.codigoProcedimientoTupa == "DCV-007" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      declaracion_72: (this.codigoProcedimientoTupa == "DCV-007" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      declaracion_81: (this.codigoProcedimientoTupa == "DCV-008" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      declaracion_91: (this.codigoProcedimientoTupa == "DCV-009" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      declaracion_92: (this.codigoProcedimientoTupa == "DCV-009" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      declaracion_101: (this.codigoProcedimientoTupa == "DCV-010" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
    });
  }
  ...
  async ngAfterViewInit(): Promise<void> {
    ...
    this.datosUsuarioLogin = this.seguridadService.getDatosUsuarioLogin(); //Datos completos del usuario login
  ...
  get f_declaracion_71(): AbstractControl { return this.formulario.get(['declaracion_71']); }
  get f_declaracion_72(): AbstractControl { return this.formulario.get(['declaracion_72']); }
  get f_declaracion_81(): AbstractControl { return this.formulario.get(['declaracion_81']); }
  get f_declaracion_91(): AbstractControl { return this.formulario.get(['declaracion_91']); }
  get f_declaracion_92(): AbstractControl { return this.formulario.get(['declaracion_92']); }
  get f_declaracion_101(): AbstractControl { return this.formulario.get(['declaracion_101']); }
  ...
  async cargarDatos(): Promise<void> {
    ...
    if (this.dataInput != null && this.dataInput.movId > 0) {
      try {
        const dataFormulario = await this.formularioTramiteService.get<Formulario003_17_3Response>(this.dataInput.tramiteReqId).toPromise();
        this.funcionesMtcService.ocultarCargando();
        ...
        this.f_declaracion_71.setValue(metaData.seccion4.declaracion_71);
        this.f_declaracion_72.setValue(metaData.seccion4.declaracion_72);
        this.f_declaracion_81.setValue(metaData.seccion4.declaracion_81);
        this.f_declaracion_91.setValue(metaData.seccion4.declaracion_91);
        this.f_declaracion_92.setValue(metaData.seccion4.declaracion_92);
        this.f_declaracion_101.setValue(metaData.seccion4.declaracion_101);
      }
      catch (e) {
        console.error(e);
        ...
        for (const repLegal of this.representanteLegal) {
          if (repLegal.nroDocumento === this.nroDocumentoLogin) {
            if (repLegal.tipoDocumento === '01') {  // DNI
              ...
              this.f_s3_rl_ApeMaterno.setValidators([Validators.maxLength(50)]);
              this.f_s3_rl_NumeroDocumento.setValidators([Validators.required, exactLengthValidator([8])]);
  ...
  actualizarValidaciones(tipoSolicitante) {
    ...
    this.f_s3_rl_Nombre.disable();
    this.f_s3_rl_ApePaterno.disable();
    this.f_s3_rl_ApeMaterno.disable();
  }
  ...
  guardarFormulario() {
    ...
    let dataGuardar: Formulario003_17_3Request = new Formulario003_17_3Request();

    dataGuardar.id = this.id;
    dataGuardar.codigo = 'F003-17.3';
    ...
    dataGuardar.metaData.seccion4.declaracion_71 = this.f_declaracion_71.value;
    dataGuardar.metaData.seccion4.declaracion_72  = this.f_declaracion_72.value;
    dataGuardar.metaData.seccion4.declaracion_81  = this.f_declaracion_81.value;
    dataGuardar.metaData.seccion4.declaracion_91  = this.f_declaracion_91.value;
    dataGuardar.metaData.seccion4.declaracion_92  = this.f_declaracion_92.value;
    dataGuardar.metaData.seccion4.declaracion_101  = this.f_declaracion_101.value;
    ...
    this.visorPdfArchivosService.get(this.uriArchivo)
      ...
      .subscribe(
        (file: Blob) => {
          ...
          modalRef.componentInstance.titleModal = "Vista Previa - Formulario 003/17.03";
