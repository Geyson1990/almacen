...
export class Formulario003_17_3Request extends Formulario {
    metaData: MetaData;
...
export class Seccion4 {
    ...
    declaracion_71: boolean; 
    declaracion_72: boolean;
    dcv_007_partida: string;
    dcv_007_asiento:string;

    declaracion_81: boolean; 

    declaracion_91: boolean; 
    declaracion_92: boolean; 

    declaracion_101: boolean; 
}
