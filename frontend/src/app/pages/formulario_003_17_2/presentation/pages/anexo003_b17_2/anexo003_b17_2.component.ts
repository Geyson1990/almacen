...
import { Anexo003_B17_2Service } from '../../../application/usecases';
...
export class Anexo003_b17_2_Component implements OnInit {
   ...
   constructor(private fb: UntypedFormBuilder,
      ...
      private anexoService: Anexo003_B17_2Service,
      ...
      setTimeout(() => {
         ...
         if (this.dataInput.movId > 0) {
            ...
            this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
               (dataAnexo: Anexo003_B17_2Response) => {
   ...
   agregarTripulacion() {
      ...
      if (this.anexoFormulario.controls['cargoForm'].value === "1" || this.anexoFormulario.controls['cargoForm'].value === "7") {
         ...
         if (resultado == undefined) {
            if (numeroDocumento !== this.numeroDocumentoSolicitante)
   ...
   guardarAnexo() {
      ...
      let dataGuardar: Anexo003_B17_2Request = new Anexo003_B17_2Request();
      //-------------------------------------    
