...
import { Anexo003_B17_2Repository } from '../repositories/anexo003_B17_2.repository';

@Injectable()
export class Anexo003_B17_2Service extends FormularioElectronicoUseCase<Anexo003_B17_2Request, Anexo003_B17_2Response> {
  constructor(
    readonly repository: Anexo003_B17_2Repository
    ) {
    super(repository)
  }
}
