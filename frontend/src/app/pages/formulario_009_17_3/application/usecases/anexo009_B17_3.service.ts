...
import { Anexo009_B17_3Repository } from '../repositories/anexo009_B17_3.repository';

@Injectable()
export class Anexo009_B17_3Service extends FormularioElectronicoUseCase<Anexo009_B17_3Request, Anexo009_B17_3Response> {
  constructor(
    readonly repository: Anexo009_B17_3Repository
    ) {
    super(repository)
  }
}