...
import { Anexo002_F28Request } from '../../../../../core/models/Anexos/Anexo002_F28NT/Anexo002_F28Request';
import { Anexo002_F28Response } from 'src/app/core/models/Anexos/Anexo002_F28NT/Anexo002_F28Response';
import { FuncionesMtcService } from '../../../../../core/services/funciones-mtc.service';
import { Anexo002F28NTService } from '../../../../../core/services/anexos/anexo002-f28NT.service';
import { Seccion1, Seccion2, Seccion3, Miembro } from '../../../../../core/models/Anexos/Anexo002_F28NT/Secciones';
...
export class Anexo002F28Component implements OnInit, AfterViewInit {  
  ...
  constructor(
    ...
    private anexoService: Anexo002F28NTService,
  ...
  async datosSolicitante(FormularioId: number): Promise<void> {
    ...
    this.formularioTramiteService.get(this.dataInput.tramiteReqRefId).subscribe(
      (dataForm: any) => {
        ...
        //this.tipoDocumentoSolicitante = metaDataForm.seccion8.
        this.solicitante = metaDataForm.seccion8.nombre;
  ...
  async cargarDatos(): Promise<void> {
    if (this.dataInput.movId > 0) {
      ...
      try {
        const dataAnexo = await this.anexoTramiteService.get<Anexo002_F28Response>(this.dataInput.tramiteReqId).toPromise();
        this.funcionesMtcService.ocultarCargando();
  ...
  save(){
    ...
    seccion1.representanteLegal = this.f_s1_pj_Nombres.value;
    seccion1.denominacion = this.f_s1_pj_RazonSocial.value;
    ...
    seccion2.miembros = listaSocios;
    /*seccion2.solicitante = this.solicitante;
    seccion2.tipoDocumentoSolicitante = "";
