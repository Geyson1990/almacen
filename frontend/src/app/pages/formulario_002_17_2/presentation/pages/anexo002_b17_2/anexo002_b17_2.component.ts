...
import { Anexo002_B17_2Service } from '../../../application/usecases';
import { A002_B17_2_Seccion2, A002_B17_2_Seccion3, A002_B17_2_Seccion4, A002_B17_2_Seccion5 } from '../../../domain/anexo002_B17_2/anexo002_B17_2Request';
...
export class Anexo002_b17_2_Component implements OnInit, AfterViewInit {
	...
	paSeccion1: string[] = ['DSTT-016', 'DSTT-017', 'DSTT-008','DSTT-019', 'DSTT-020','DSTT-021'];
	paSeccion11 : string[] = ['DSTT-016', 'DSTT-019', 'DSTT-020','DSTT-021'];
	...
	paTipoServicio = [
		...
		{ pa: 'DSTT-021', tipoSolicitud: '0', tipoServicio: '10' }, // CITV TRANSPORTE DE MERCANCIAS PRIVADO
		{ pa: 'DSTT-021', tipoSolicitud: '0', tipoServicio: '16' }, // CITV TRANSPORTE INTERNACIONAL DE MERCANCIAS POR CARRETERA DE 
	...
	constructor(
		...
		private anexoService: Anexo002_B17_2Service,
	...
	async ngAfterViewInit(): Promise<void> {
		...
		if (this.paSeccion11.indexOf(this.codigoProcedimientoTupa) > -1) {
			this.ambito = false;
		} else {
			this.ambito = true;
		}
