...
import { Flota, Conductor, Pasajero, Tripulante } from '../../../domain/formulario002_17_2/formulario002_17_2Request';
import { RepresentanteLegal } from 'src/app/core/models/SunatModel';
import { TipoDocumentoModel } from 'src/app/core/models/TipoDocumentoModel';
import { Formulario002_17_2Service } from '../../../application/usecases';
...
export class FormularioComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private formularioService: Formulario002_17_2Service,
    ...
    this.formularioFG = this.formBuilder.group({
      f_Seccion2FG: this.formBuilder.group({
        f_s2_PerNatFG: this.formBuilder.group({
          ...
          f_s2_pn_TelefonoFC: ['', [Validators.maxLength(11)]],
        ...
        f_s2_PerJurFG: this.formBuilder.group({
          ...
          f_s2_pj_RepLegalFG: this.formBuilder.group({
            ...
            f_s2_pj_rl_TelefonoFC: ['', [Validators.maxLength(11)]],
