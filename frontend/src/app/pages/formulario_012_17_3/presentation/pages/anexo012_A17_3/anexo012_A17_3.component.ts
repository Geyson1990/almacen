...
import { AbstractControlOptions, FormBuilder, FormGroup, Validators, FormControl, FormArray, Form } from '@angular/forms';
...
import { Anexo012_A17_3Request, MetaData, Seccion2, Opciones, Director, InstructorConocimientos, InstructorHabilidades } from '../../../domain/anexo012_A17_3/anexo012_A17_3Request';
...
import { Anexo012_A17_3Service } from '../../../application/usecases';
...
import { Anexo012_A17_3Response, } from '../../../domain/anexo012_A17_3/anexo012_A17_3Response';
import { Anexo012_A17_3Request, Seccion1, Seccion2, Seccion3, Seccion4 } from '../../../domain/anexo012_A17_3/anexo012_A17_3Request';
...
export class Anexo012_A17_3_Component implements OnInit {
...
recuperarInformacion(){
  ...
  if (this.dataInput.rutaDocumento) {
    ...
    this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
      (dataAnexo: Anexo012_A17_3Response) => {
