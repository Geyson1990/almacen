...
import { FormularioResponse } from 'src/app/core/models/Formularios/Formulario012_17_3/FormularioResponse';
import { FormularioRequestPost } from 'src/app/core/models/Formularios/Formulario012_17_3/FormularioRequestPost';
import { Seccion1, Seccion2, Seccion3, Seccion4 } from 'src/app/core/models/Formularios/Formulario012_17_3/Secciones';
...
export class FormularioComponent implements OnInit {
      ...
      if (tipoDocumento === '01') {//DNI
        ...
        this.reniecService.getDni(numeroDocumento).subscribe(
          (respuesta) => {
            ...
            this.datosUsuarioLogin.nombres + " " + this.datosUsuarioLogin.apePaterno.trim() +" "+ this.datosUsuarioLogin.apeMaterno.trim()
  ...
  buscarNumeroDocumento() {
    ...
    if(this.codigoTupa==="S-DCV-002" || this.codigoTupa==="DCV-046" || this.codigoTupa==="DCV-051" ) {
        ...
        */
        ...
        this.SncService.getDni('13',numeroDocumento).subscribe( // "13" = CARNET DE ESTRANJERIA
          (res:any) => {
            ...
            /*this.contactForm.get("nombreHC").setValue(res.ReglasNombre);
            this.contactForm.get("notaHC").setValue(res.ReglasCertificado);
            this.fechaCE = this.dateFormatString(res.ReglasFecha);
            this.setDateValue("fechaCE", this.fechaCE);*/
