...
import { Formulario006_17_3Service } from '../../../application/usecases';
...
export class FormularioComponent implements OnInit, AfterViewInit {
   ...
   txtTituloCompleto: string = "FORMULARIO 006/17.03 ENTIDAD VERIFICADORA";
   ...
   //Datos de Formulario
   tituloFormulario = "FORMULARIO 006/17.03 ENTIDAD VERIFICADORA";
   tipoPersona: number = 1;

   seccion1: string[] = ["DCV-019", "DCV-020"];
   activarSeccion1: boolean = true;

   seccionDatosEmpresa: string[] = ["DCV-019", "DCV-020"];
   activarDatosEmpresa: boolean = true;

   paDJ12: string[] = ["DCV-020"];
   
   activarDJ12: boolean = false;
   ...
   constructor(
      ...
      private formularioService: Formulario006_17_3Service,
   ...
   async ngOnInit(): Promise<void> {
      ...
      if (this.paDJ12.indexOf(this.codigoProcedimientoTupa) > -1) this.activarDJ12 = true; else this.activarDJ12 = false;
      ...
      this.formulario = this.fb.group({
         ...
         declaracion_10: this.fb.control(false, [Validators.requiredTrue]),
         declaracion_11: this.fb.control(false, [Validators.requiredTrue]),
         declaracion_12: (this.codigoProcedimientoTupa == "DCV-020" ? this.fb.control(false, [Validators.requiredTrue]) : this.fb.control(false)),
      });
   }
   ...
   get f_declaracion_9(): AbstractControl { return this.formulario.get(['declaracion_9']); }
   get f_declaracion_10(): AbstractControl { return this.formulario.get(['declaracion_10']); }
   ...
   async cargarDatos(): Promise<void> {
      ...
      if (this.dataInput != null && this.dataInput.movId > 0) {
         try {
            ...
            const dataFormulario = await this.formularioTramiteService.get<Formulario006_17_3Response>(this.dataInput.tramiteReqId).toPromise();
            this.funcionesMtcService.ocultarCargando();
            ...
            this.f_declaracion_7.setValue(metaData.seccion4.declaracion_7);
            this.f_declaracion_8.setValue(metaData.seccion4.declaracion_8);
            this.f_declaracion_9.setValue(metaData.seccion4.declaracion_9);
            this.f_declaracion_10.setValue(metaData.seccion4.declaracion_10);
            this.f_declaracion_11.setValue(metaData.seccion4.declaracion_11);
            this.f_declaracion_12.setValue(metaData.seccion4.declaracion_12);
   ...
   guardarFormulario() {
      ...
      let dataGuardar: Formulario006_17_3Request = new Formulario006_17_3Request();

      dataGuardar.id = this.id;
      dataGuardar.codigo = 'F006-17.3';
      dataGuardar.formularioId = 6;
      ...
      dataGuardar.metaData.seccion4.declaracion_7  = this.f_declaracion_7.value;
      dataGuardar.metaData.seccion4.declaracion_8  = this.f_declaracion_8.value;
      dataGuardar.metaData.seccion4.declaracion_9  = this.f_declaracion_9.value;
      dataGuardar.metaData.seccion4.declaracion_10  = this.f_declaracion_10.value;
      dataGuardar.metaData.seccion4.declaracion_11  = this.f_declaracion_11.value;
      dataGuardar.metaData.seccion4.declaracion_12  = this.f_declaracion_12.value;
      ...
      this.visorPdfArchivosService.get(this.uriArchivo)
         ...
         .subscribe(
            (file: Blob) => {
               ...
               modalRef.componentInstance.titleModal = "Vista Previa - Formulario 006/17.03";
