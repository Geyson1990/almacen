...
//  import { Anexo002_E27Response } from '../../../../../core/models/Anexos/Anexo002_e27/Anexo002_E27Response';
//  import { MetaData } from 'src/app/core/models/Anexos/Anexo002_E27/MetaData';
import { UbigeoComponent } from 'src/app/shared/components/forms/ubigeo/ubigeo.component';
//  import { Anexo002_E27Request } from 'src/app/core/models/Anexos/Anexo002_E27/Anexo002_E27Request';
...
//  import { Anexo002E27Service } from 'src/app/core/services/anexos/anexo002-e27.service';
...
import { Anexo002_E27Service } from '../../../application/usecases';
//import { Seccion2, Seccion3 } from '../../../../../core/models/Anexos/Anexo002_E27/Secciones';

@Component({
  // tslint:disable-next-line: component-selector
  selector: 'app-anexo002_E27',
  templateUrl: './anexo002_E27.component.html',
  styleUrls: ['./anexo002_E27.component.css']
})

// tslint:disable-next-line: class-name
export class Anexo002_E27Component implements OnInit, AfterViewInit, AfterViewChecked {
  @Input() public dataInput: any;
  @ViewChild('acc') acc: NgbAccordionDirective;

  @ViewChild('ubigeoCmpEstFija1') ubigeoEstFija1Component: UbigeoComponent;

  txtTitulo = 'ANEXO 002-E/27 ESTACIONES DE ACCESO FIJO INALÁMBRICO - Descripción de las Estaciones, Ubicación y Equipamiento';
  ...
  listaTipoServicio: any = [
    { id: "portador_local", nombre: 'Portador Local' },
    { id: "telefonico_fijo_local", nombre: 'Telefónico Fijo Local' },
  ];
  ...
  constructor(
    ...
    private anexoService: Anexo002_E27Service,
  ...
  //seccion 5
  get a_Seccion5(): UntypedFormGroup { return this.anexoFG.get('a_Seccion5') as UntypedFormGroup; }
  get a_s5_declaracion1FC(): UntypedFormControl { return this.a_Seccion5.get('a_s5_declaracion1FC') as UntypedFormControl; }
  ...
  async cargarDatos(): Promise<void> {
    ...
    if (this.dataInput.movId > 0) {
      ...
      try {
        const dataAnexo = await this.anexoTramiteService.get<Anexo002_E27Response>(this.dataInput.tramiteReqId).toPromise();
  ...
  async descargarPdf(): Promise<void> {
    ...
    try {
      ...
      const urlPdf = URL.createObjectURL(file);
      modalRef.componentInstance.pdfUrl = urlPdf;
      modalRef.componentInstance.titleModal = 'Vista Previa - Anexo 002-E/27';
    }
    catch (e) {
      console.error(e);
      this.funcionesMtcService
  ...
  async guardarAnexo(): Promise<void> {
    ...
    const dataGuardar = new Anexo002_E27Request();
    // -------------------------------------
