/**
 * Formulario 002/27 utilizado por los procedimientos DGPPC-015
...
// import { Formulario002_27Request } from 'src/app/core/models/Formularios/Formulario002_27/Formulario002_27Request';
// import { Formulario002_27Response } from 'src/app/core/models/Formularios/Formulario002_27/Formulario002_27Response';
// import { Formulario00227Service } from '../../../../core/services/formularios/formulario002-27.service';
...
import { Formulario002_27Service } from '../../../application/usecases';
...
export class FormularioComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private formularioService: Formulario002_27Service,
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.formulario = this.fb.group({
      ...
      Seccion3: this.fb.group({
        ...
        HabilitacionProfesion: this.fb.group({
          hp_colegioProfesional: ['', [Validators.required]],
          hp_nroColegiatura: ['', [Validators.required]]
        })
  ...
  get f_s3_1_HabilitacionProfesion(): UntypedFormGroup { return this.f_Seccion3.get('HabilitacionProfesion') as UntypedFormGroup; }
  get f_s3_1_ColegioProfesional(): AbstractControl { return this.f_s3_1_HabilitacionProfesion.get(['hp_colegioProfesional']); }
  get f_s3_1_NroColegiatura(): AbstractControl { return this.f_s3_1_HabilitacionProfesion.get(['hp_nroColegiatura']); }
  ...
  async cargarDatos(): Promise<void> {
    ...
    if (this.dataInput != null && this.dataInput.movId > 0) {
      try {
        const dataFormulario = await this.formularioTramiteService.get<Formulario002_27Response>(this.dataInput.tramiteReqId).toPromise();
        this.funcionesMtcService.ocultarCargando();
        ...
        this.f_s3_1_ColegioProfesional.setValue(metaData.seccion3.HabilitacionProfesional.colegioProfesional);
        this.f_s3_1_NroColegiatura.setValue(metaData.seccion3.HabilitacionProfesional.nroColegiatura);
  ...
  guardarFormulario() {
    ...
    let dataGuardar: Formulario002_27Request = new Formulario002_27Request();

    dataGuardar.id = this.id;
    dataGuardar.codigo = 'F002-27';
    ...
    dataGuardar.metaData.seccion3.habilitacionProfesional.colegioProfesional = this.f_s3_1_ColegioProfesional.value;
    dataGuardar.metaData.seccion3.habilitacionProfesional.nroColegiatura = this.f_s3_1_NroColegiatura.value;
