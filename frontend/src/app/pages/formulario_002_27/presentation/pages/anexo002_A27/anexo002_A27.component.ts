...
import { Anexo002_A27Request, HojaDatos, MetaData } from '../../../domain/anexo002_A27/anexo002_A27Request';
...
import { FormEstacionRadioelectricaComponent } from '../../components/form-estacion-radioelectrica/form-estacion-radioelectrica.component';
import { Anexo002_A27Service } from '../../../application/usecases';

@Component({
  selector: 'app-anexo002_A27',
  templateUrl: './anexo002_A27.component.html',
  styleUrls: ['./anexo002_A27.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class Anexo002_A27Component implements OnInit {
  ...
  constructor(
    ...
    private anexoService: Anexo002_A27Service,
  ...
  abrirModal(idx:number|null=null) {
    console.log("idx", idx)
    const modalRef: NgbModalRef = this.modalService.open(FormEstacionRadioelectricaComponent, { centered: true, size:"xl", scrollable: true });
