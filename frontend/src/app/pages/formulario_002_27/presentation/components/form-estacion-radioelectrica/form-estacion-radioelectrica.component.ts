...
import { HojaDatos } from '../../../domain/anexo002_A27/anexo002_A27Request';
...
@Component({
  selector: 'app-form-estacion-radioelectrica',
  templateUrl: './form-estacion-radioelectrica.component.html',
  styleUrls: ['./form-estacion-radioelectrica.component.css'],
})
export class FormEstacionRadioelectricaComponent implements OnInit {
