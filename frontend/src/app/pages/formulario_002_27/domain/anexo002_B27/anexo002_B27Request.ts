...
export class Anexo002_B27Request extends Anexo {
  metaData: MetaData;
...
export class Seccion1 {
  ...
  nroPortadorasTransmision: number
  frecuenciaUplink: number
  frecuenciaDownlink: number
...
export class Seccion2 {
  ...
  nroTransponedor: number
  tipoAmplificadorHPA: string
  tipoAmplificadorSSPA: string
}
...
export class Seccion3 {
  ...
  diametroAntena: number
  anguloElevacionAntena: number
  azimut: number
}

export class Seccion4 {
  nombrePosicionOrbital: string
}
