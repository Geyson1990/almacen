...
import { Formulario008_17_3Service } from '../../../application/usecases';
...
export class FormularioComponent implements OnInit, AfterViewInit {
   ...
   constructor(
      ...
      private formularioService: Formulario008_17_3Service,
      ...
      this.formulario = this.fb.group({
         ...
         Seccion3: this.fb.group({
            f_s3_datosEmpresa: this.fb.group({
               f_s3_de_partida: (this.codigoProcedimientoTupa=="DCV-025" ? ['', [Validators.required, Validators.maxLength(11)]] : ['']),
               f_s3_de_asiento: (this.codigoProcedimientoTupa=="DCV-025" ? ['', [Validators.required, Validators.maxLength(11)]] : ['']),
               f_s3_de_certificado:(this.codigoProcedimientoTupa=="DCV-025" ? ['', [Validators.required, Validators.maxLength(11)]] : ['']),
            }),
         ...
         declaracion_3: (this.codigoProcedimientoTupa=="DCV-026" ? this.fb.control(false) : this.fb.control(false, [Validators.requiredTrue])),
         declaracion_4: (this.codigoProcedimientoTupa=="DCV-026" ? this.fb.control(false) : this.fb.control(false, [Validators.requiredTrue])),
         declaracion_5: (this.codigoProcedimientoTupa=="DCV-026" ? this.fb.control(false) : this.fb.control(false, [Validators.requiredTrue])),
         declaracion_6: (this.codigoProcedimientoTupa=="DCV-025" ? this.fb.control(false) : this.fb.control(false, [Validators.requiredTrue]))
      });
   }
   ...
   get f_s3_de_certificado(): AbstractControl { return this.f_s3_datosEmpresa.get(['f_s3_de_certificado']); }
   ...
   async cargarDatos(): Promise<void> {
      ...
      if (this.dataInput != null && this.dataInput.movId > 0) {
         try {
            ...
            const dataFormulario = await this.formularioTramiteService.get<Formulario008_17_3Response>(this.dataInput.tramiteReqId).toPromise();
            this.funcionesMtcService.ocultarCargando();
            ...
            this.f_s3_de_certificado.setValue(metaData.seccion4.certificado);
   ...
   guardarFormulario() {
      ...
      let dataGuardar: Formulario008_17_3Request = new Formulario008_17_3Request();

      dataGuardar.id = this.id;
      dataGuardar.codigo = 'F008-17.3';
      dataGuardar.formularioId = 8;
      ...
      dataGuardar.metaData.seccion4.certificado = this.f_s3_de_certificado.value;
