...
import { Formulario001_17_2Service } from '../../../application/usecases';
...
import { Seccion1, Seccion3, Seccion5 } from '../../../domain/formulario001_17_2/formulario001_17_2Request';
...
export class FormularioComponent implements OnInit, AfterViewInit {
  ...
  pathPdfCroquisSeleccionado: any = null;
  ...
  //Datos de Formulario
  txtTituloCompleto = 'FORMULARIO 001-17.2 INFRAESTRUCTURA DEL TRANSPORTE FERROVIARIO';
  ...
  constructor(
    ...
    private formularioService: Formulario001_17_2Service,
        ...
        if(this.dataInput != null && this.dataInput.movId > 0){
          ...
          this.formularioTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
            (dataFormulario: Formulario001_17_2Response) => {
              ...
              this.formulario.controls["pasajeros"].setValue(metaData.seccion1.pasajeros);
              this.formulario.controls["mercancia"].setValue(metaData.seccion1.mercancia);
              this.formulario.controls["rutaFerroviaria"].setValue(metaData.seccion1.rutaFerroviaria);
              this.pathPdfCroquisSeleccionado = metaData.seccion1.pathNameCroquis;
              ...
              this.formulario.controls["declaracion_3"].setValue(metaData.seccion5.declaracion_3);
              this.formulario.controls["declaracion_4"].setValue(metaData.seccion5.declaracion_4);
              this.formulario.controls["declaracion_5"].setValue(metaData.seccion5.declaracion_5);
              this.formulario.controls["declaracion_6"].setValue(metaData.seccion5.declaracion_6);
              this.formulario.controls["declaracion_7"].setValue(metaData.seccion5.declaracion_7);
              this.formulario.controls["declaracion_8"].setValue(metaData.seccion5.declaracion_8);
              this.formulario.controls["declaracion_9"].setValue(metaData.seccion5.declaracion_9);
...
/*
  onChangeCroquis(): void {
    this.visibleButtonCroquis = this.formulario.controls['estatutoSocial'].value.trim();
  ...
  vistaPreviaCroquis(): void {
    if (this.pathPdfCroquisSeleccionado === null || this.filePdfCroquisSeleccionado !== null) {
      const modalRef = this.modalService.open(VistaPdfComponent, { size: 'lg', scrollable: true });
      const urlPdf = URL.createObjectURL(this.filePdfCroquisSeleccionado);
      modalRef.componentInstance.pdfUrl = urlPdf;
      modalRef.componentInstance.titleModal = 'Vista Previa - Detalle Ruta Ferroviaria';
    } else {
      this.funcionesMtcService.mostrarCargando();

      this.visorPdfArchivosService.get(this.pathPdfCroquisSeleccionado)
        .subscribe(
          (file: Blob) => {
            this.funcionesMtcService.ocultarCargando();
            const modalRef = this.modalService.open(VistaPdfComponent, { size: 'lg', scrollable: true });
  ...
  guardarFormulario() {
    if (this.formulario.invalid === true)
      ...
      dataGuardar.metaData.seccion1.rutaFerroviaria = (this.formulario.controls['rutaFerroviaria'].value?.toUpperCase());
      ...
      dataGuardar.metaData.seccion1.fileCroquis = this.filePdfCroquisSeleccionado;
      dataGuardar.metaData.seccion1.pathNameCroquis = this.pathPdfCroquisSeleccionado;
