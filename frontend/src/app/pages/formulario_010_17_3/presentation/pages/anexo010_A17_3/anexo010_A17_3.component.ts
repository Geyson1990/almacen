...
import { Anexo010_A17_3Request, MetaData, Seccion2, Personal, Titulo } from '../../../domain/anexo010_A17_3/anexo010_A17_3Request';
...
import { Anexo010_A17_3Service } from '../../../application/usecases';
...
@Component({
	...
	selector: 'app-anexo010_A17_3',
	templateUrl: './anexo010_A17_3.component.html',
	styleUrls: ['./anexo010_A17_3.component.css']
})

// tslint:disable-next-line: class-name
export class Anexo010_A17_3_Component implements OnInit, AfterViewInit, AfterViewChecked {
	...
	txtTitulo = 'ANEXO 010-A/17.03 NOMINA DEL PERSONAL TECNICO DEL TALLER DE CONVERSION A GAS LICUADO DE PETROLEO - GLP O TALLER DE CONVERSION A GAS NATURAL VEHICULAR - GNV';
	...
	constructor(
		...
		private anexoService: Anexo010_A17_3Service,
	...
	async cargarDatos(): Promise<void> {
		...
		if (this.dataInput.movId > 0) {
			...
			try {
				const dataAnexo = await this.anexoTramiteService.get<Anexo010_A17_3Response>(this.dataInput.tramiteReqId).toPromise();
	...
	async descargarPdf(): Promise<void> {
		...
		try {
			...
			const urlPdf = URL.createObjectURL(file);
			modalRef.componentInstance.pdfUrl = urlPdf;
			modalRef.componentInstance.titleModal = 'Vista Previa - Anexo 010-A/17.03';
		}
		catch (e) {
			console.error(e);
			this.funcionesMtcService
	...
	async guardarAnexo(): Promise<void> {
		...
		const dataGuardar = new Anexo010_A17_3Request();
		// -------------------------------------
