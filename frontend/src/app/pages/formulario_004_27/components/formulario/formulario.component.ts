...
import { MetaData } from 'src/app/core/models/Formularios/Formulario004_27/MetaData';
...
import { Formulario004_27Request } from 'src/app/core/models/Formularios/Formulario004_27/Formulario004_27Request';
import { Formulario004_27Response } from 'src/app/core/models/Formularios/Formulario004_27/Formulario004_27Response';
import { Formulario00427Service } from 'src/app/core/services/formularios/formulario004-27.service';
...
export class FormularioComponent implements OnInit {
  ...
  txtTitulo = 'FORMULARIO 004/27 - REGISTRO DE SERVICIOS PÚBLICOS';
  ...
  constructor(
    ...
    private formularioService: Formulario00427Service,
  ...
  ngOnInit(): void {
    ...
    if (this.dataInput != null && this.id > 0) {
        ...
        this.formularioTramiteService.get<Formulario004_27Response>(this.tramiteReqId)
        .subscribe((response) => {
  ...
  setFormPJ() {
    this.formulario = this.formBuilder.group({
      ...
      Ruc: [{value:'', disabled:true}, [Validators.required, exactLengthValidator([11])]],
      Domicilio: [{value:'', disabled:false}, [Validators.required, noWhitespaceValidator(), Validators.maxLength(150)]],
  ...
  guardarFormulario() {
    ...
    const dataGuardar = new Formulario004_27Request();

    dataGuardar.id = this.id;
    dataGuardar.codigo = 'F004-27';
    ...
    dataGuardar.metaData.seccion5.tipoDocumentoFirmante = this.idTipoDocumentoIdentidadLogin == "01" ? "D.N.I." : ""
  ...
  async descargarPdf(): Promise<void> { // OK
    ...
    try {
      ...
      modalRef.componentInstance.titleModal = 'Vista Previa - Formulario 004/27';
    }
    catch (e) {
