...
import { Anexo001_A27Request } from 'src/app/core/models/Anexos/Anexo001_A27NT/Anexo001_A27Request';
import { Anexo001_A27Response } from 'src/app/core/models/Anexos/Anexo001_A27NT/Anexo001_A27Response';
import { TipoDocumentoModel } from 'src/app/core/models/TipoDocumentoModel';
import { Anexo001A27NTService } from 'src/app/core/services/anexos/anexo001-a27NT.service';
...
import { HojaDatos, MetaData } from 'src/app/core/models/Anexos/Anexo001_A27NT/MetaData';
...
export class Anexo001A27Component implements OnInit {
  ...
  txtTitulo = 'ANEXO 001-A/27 - CONCESIÓN ÚNICA PRIMER SERVICIO PÚBLICO DE TELECOMUNICACIONES A PRESTAR'
  ...
  constructor(
    ...
    private anexoService: Anexo001A27NTService,
  ...
  ngOnInit() {
    ...
    if (this.dataInput != null && this.id > 0) {
        ...
        this.anexoTramiteService.get<Anexo001_A27Response>(this.tramiteReqId)
        .subscribe((dataAnexo) => {
  ...
  guardarAnexo() {
    ...
    const dataGuardar: Anexo001_A27Request = new Anexo001_A27Request();
