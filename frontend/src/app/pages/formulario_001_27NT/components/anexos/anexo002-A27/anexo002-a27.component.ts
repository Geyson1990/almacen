...
import { MetaData } from 'src/app/core/models/Anexos/Anexo002_A27NT/MetaData';
import { ReniecService } from 'src/app/core/services/servicios/reniec.service';
import { ExtranjeriaService } from 'src/app/core/services/servicios/extranjeria.service';
import { UbigeoService } from 'src/app/core/services/maestros/ubigeo.service';
import { Anexo002_A27Request } from 'src/app/core/models/Anexos/Anexo002_A27NT/Anexo002_A27Request';
import { Anexo002A27NTService } from 'src/app/core/services/anexos/anexo002-a27NT.service';
import { Anexo002_A27Response } from 'src/app/core/models/Anexos/Anexo002_A27NT/Anexo002_A27Response';
import { exactLengthValidator } from 'src/app/helpers/validator';

@Component({
  selector: 'app-anexo002-a27',
  templateUrl: './anexo002-a27.component.html',
  styleUrls: ['./anexo002-a27.component.css'],
})
export class Anexo002A27Component implements OnInit {
  ...
  txtTitulo = 'ANEXO 002-A/27 - ESTACIONES RADIOELÉCTRICAS'
  ...
  constructor(
    ...
    private anexoService: Anexo002A27NTService,
  ...
  ngOnInit(): void {
    ...
    if (this.dataInput != null && this.id > 0) {
        ...
        this.anexoTramiteService.get<Anexo002_A27Response>(this.tramiteReqId)
        .subscribe((dataAnexo) => {
  ...
  setForm() {
    this.formulario = this.fb.group({
      seccion1: this.fb.group({
        ...
        indicativo: [""],
        frecuenciaTx: ["", [Validators.required]],
        polarizacionTx: ["", [Validators.required]],
        frecuenciaRx: ["", [Validators.required]],
        polarizacionRx: ["", [Validators.required]],
  ...
  get frecuenciaTx(): AbstractControl { return this.formulario.get('seccion1.frecuenciaTx'); }
  get polarizacionTx(): AbstractControl { return this.formulario.get('seccion1.polarizacionTx'); }
  get frecuenciaRx(): AbstractControl { return this.formulario.get('seccion1.frecuenciaRx'); }
  get polarizacionRx(): AbstractControl { return this.formulario.get('seccion1.polarizacionRx'); }
  get bloqueHorario(): AbstractControl { return this.formulario.get('seccion1.bloqueHorario'); }
  get configuracion(): AbstractControl { return this.formulario.get('seccion1.configuracion'); }
  ...
  get estacion(): AbstractControl { return this.formulario.get('seccion4.estacion'); }
  get azimut(): AbstractControl { return this.formulario.get('seccion4.azimut'); }
  get distancia(): AbstractControl { return this.formulario.get('seccion4.distancia'); }
  ...
  guardarAnexo() {
    ...
    const dataGuardar: Anexo002_A27Request = new Anexo002_A27Request();
