...
import { Anexo002F17Service } from 'src/app/core/services/anexos/anexo002-f17.service';
import { Anexo002_F17Response } from 'src/app/core/models/Anexos/Anexo002_F17/Anexo002_F17Response';
...
@Component({
  selector: 'app-anexo002-f17',
  templateUrl: './anexo002-f17.component.html',
  styleUrls: ['./anexo002-f17.component.css']
})
export class Anexo002F17Component implements OnInit {
  ...
  constructor(private fb: UntypedFormBuilder,
    ...
    private anexoService: Anexo002F17Service,
      ...
      this.visorPdfArchivosService.get(this.uriArchivo)
        .subscribe(
          (file: Blob) => {
            ...
            modalRef.componentInstance.titleModal = "Vista Previa - Anexo 002-F/17";
          },
          error => {
    ...
    recuperarInformacion(){
        ...
        if (this.dataInput.movId > 0 && this.dataInput.completo === false) {
            ...
            this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
              (dataAnexo: Anexo002_F17Response) => {
    ...
    heredarInformacionFormulario(){
        ...
        this.funcionesMtcService.mostrarCargando();
          //
          //this.dataInput.tramiteReqRefId
