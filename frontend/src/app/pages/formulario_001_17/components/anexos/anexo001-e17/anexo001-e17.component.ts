...
import { Anexo001_E17Request } from 'src/app/core/models/Anexos/Anexo001_E17/Anexo001_E17Request';
import { Anexo001_E17Response } from 'src/app/core/models/Anexos/Anexo001_E17/Anexo001_E17Response';
...
import { Anexo001E17Service } from 'src/app/core/services/anexos/anexo001-e17.service';
...
@Component({
  selector: 'app-anexo001-e17',
  templateUrl: './anexo001-e17.component.html',
  styleUrls: ['./anexo001-e17.component.css']
})
export class Anexo001E17Component implements OnInit {
  ...
  constructor(private fb: UntypedFormBuilder,
    ...
    private anexoService: Anexo001E17Service,
        ...
        (dataForm: any) => {
          ...
          if (this.dataInput.movId > 0) {
            ...
            this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
              (dataAnexo: Anexo001_E17Response) => {
                this.funcionesMtcService.ocultarCargando();
    ...
    this.visorPdfArchivosService.get(this.uriArchivo)
      ...
      .subscribe(
        (file: Blob) => {
          ...
          modalRef.componentInstance.pdfUrl = urlPdf;
          modalRef.componentInstance.titleModal = "Vista Previa - Anexo 001-E/17";
        },
        error => {
          this.funcionesMtcService
            .ocultarCargando()
  ...
  guardarAnexo() {
    ...
    let dataGuardar: Anexo001_E17Request = new Anexo001_E17Request();
    //-------------------------------------    
