...
import { Anexo003D17Service } from 'src/app/core/services/anexos/anexo003-d17.service';
...
import { Vinculos, Documentos, Encargados, A003_D17_Seccion1, A003_D17_Seccion2} from 'src/app/core/models/Anexos/Anexo003_D17/Secciones';
import { ReniecService } from 'src/app/core/services/servicios/reniec.service';
import { ExtranjeriaService } from 'src/app/core/services/servicios/extranjeria.service';
import { Anexo003_D17Request } from 'src/app/core/models/Anexos/Anexo003_D17/Anexo003_D17Request';
import { Anexo003_D17Response } from 'src/app/core/models/Anexos/Anexo003_D17/Anexo003_D17Response';
...
@Component({
  selector: 'app-anexo003-d17',
  templateUrl: './anexo003-d17.component.html',
  styleUrls: ['./anexo003-d17.component.css']
})
export class Anexo003D17Component implements OnInit {
  ...
  tituloAnexo='SERVICIOS DE TRANSPORTE TERRESTRE ESPECIAL DE PERSONAS (TRABAJADORES, ESTUDIANTES, SOCIAL)'
  submitted=false;
  codigoTupa: string=''
  ...
  @ViewChild('acc') acc: NgbAccordionDirective ;
    ...
    constructor(
      ...
      private anexoService: Anexo003D17Service,
    ...
    public datos = {
        ...
        this.visorPdfArchivosService.get(this.uriArchivo)
          .subscribe(
            (file: Blob) => {
              ...
              modalRef.componentInstance.titleModal = "Vista Previa - Anexo 003- D/17";
            },
            error => {
              this.funcionesMtcService
                .ocultarCargando()
      ...
      guardarAnexo() {
        ...
        let dataGuardar : Anexo003_D17Request = new Anexo003_D17Request();
        ...
        //SECCION1
        let seccion1: A003_D17_Seccion1 = new A003_D17_Seccion1();
        ...
        let seccion2: A003_D17_Seccion2=new A003_D17_Seccion2();
  ...
  recuperarInformacion(){
    ...
    if (this.dataInput.rutaDocumento) {
      ...
      this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
        (dataAnexo: Anexo003_D17Response) => {
