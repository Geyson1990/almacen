...
import { Anexo002_A28Request } from '../../../../../core/models/Anexos/Anexo002_A28/Anexo002_A28Request';
...
import { A002_A28_Seccion1, A002_A28_Seccion2, Familiar, Parentesco } from '../../../../../core/models/Anexos/Anexo002_A28/Secciones';
...
import { Anexo002_A28Response } from 'src/app/core/models/Anexos/Anexo002_A28/Anexo002_A28Response';
...
export class Anexo002A28Component implements OnInit {  
  ...
  recuperarInformacion(){
    ...
    if (this.dataInput.movId > 0 && this.dataInput.completo === false) {
        ...
        this.anexoTramiteService.get<any>(this.dataInput.tramiteReqId).subscribe(
          (dataAnexo: Anexo002_A28Response) => {
