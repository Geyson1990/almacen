...
import { Anexo001_G28NTResponse } from '../../../../../core/models/Anexos/Anexo001_G28NT/Anexo001_G28NTResponse';
import { MetaData } from 'src/app/core/models/Anexos/Anexo001_G28NT/MetaData';
import { UbigeoComponent } from 'src/app/shared/components/forms/ubigeo/ubigeo.component';
import { Anexo001_G28NTRequest } from 'src/app/core/models/Anexos/Anexo001_G28NT/Anexo001_G28NTRequest';
...
import { Antena, Equipo, Satelite } from 'src/app/core/models/Anexos/Anexo001_G28NT/Secciones';
import { Anexo001G28NTService } from 'src/app/core/services/anexos/anexo001-g28NT.service';

@Component({
  // tslint:disable-next-line: component-selector
  selector: 'app-anexo001_g28',
  templateUrl: './anexo001_g28nt.component.html',
  styleUrls: ['./anexo001_g28nt.component.css']
})

// tslint:disable-next-line: class-name
export class Anexo001_g28nt_Component implements OnInit, AfterViewInit {
  ...
  txtTitulo = 'ANEXO 001-G/28 PERFIL DEL PROYECTO TÉCNICO Asignación Temporal de Espectro Radioeléctrico para servicios privados';
  ...
  constructor(
    ...
    private anexoService: Anexo001G28NTService,
  ...
  ngOnInit(): void {
    ...
    this.anexoFG = this.fb.group({
      a_Seccion2FG: this.fb.group({
        a_s2_ModalidadFG: this.fb.group({
          a_s2_mo_TerrHfFC: [false],
          a_s2_mo_TerrVhfFC: [false],
          a_s2_mo_TerrUhfFC: [false],
          a_s2_mo_TerrShfFC: [false],
          a_s2_mo_MariHfFC: [false],
          a_s2_mo_MariVhfFC: [false],
          a_s2_mo_MariUhfFC: [false],
          a_s2_mo_MariShfFC: [false],
          a_s2_mo_AeroHfFC: [false],
          a_s2_mo_AeroVhfFC: [false],
          a_s2_mo_AeroUhfFC: [false],
          a_s2_mo_AeroShfFC: [false]
        }, {
          validators: [
      ...
      a_Seccion3bFG: this.fb.group({
        ...
        a_s3b_AlturaTorFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(10)]],
    ...
    this.equipoFG = this.fb.group({
      ...
      eq_CaractFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(30)]],
    });
  ...
  async ngAfterViewInit(): Promise<void> {
    ...
    this.a_Seccion3aFG.disable({ emitEvent: false });

    this.onChangeSatFijo();
    this.onChangeSatMovil();
  ...
  get a_s2_ModalidadFG(): UntypedFormGroup { return this.a_Seccion2FG.get('a_s2_ModalidadFG') as UntypedFormGroup; }
  get a_s2_mo_TerrHfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_TerrHfFC') as UntypedFormControl; }
  get a_s2_mo_TerrVhfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_TerrVhfFC') as UntypedFormControl; }
  get a_s2_mo_TerrUhfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_TerrUhfFC') as UntypedFormControl; }
  get a_s2_mo_TerrShfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_TerrUhfFC') as UntypedFormControl; }
  get a_s2_mo_MariHfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_MariHfFC') as UntypedFormControl; }
  get a_s2_mo_MariVhfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_MariVhfFC') as UntypedFormControl; }
  get a_s2_mo_MariUhfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_MariUhfFC') as UntypedFormControl; }
  get a_s2_mo_MariShfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_MariUhfFC') as UntypedFormControl; }
  get a_s2_mo_AeroHfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_AeroHfFC') as UntypedFormControl; }
  get a_s2_mo_AeroVhfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_AeroVhfFC') as UntypedFormControl; }
  get a_s2_mo_AeroUhfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_AeroUhfFC') as UntypedFormControl; }
  get a_s2_mo_AeroShfFC(): UntypedFormControl { return this.a_s2_ModalidadFG.get('a_s2_mo_AeroUhfFC') as UntypedFormControl; }
  ...
  get a_s3b_AlturaTorFC(): UntypedFormControl { return this.a_Seccion3bFG.get('a_s3b_AlturaTorFC') as UntypedFormControl; }
  ...
  get eq_CaractFC(): UntypedFormControl { return this.equipoFG.get('eq_CaractFC') as UntypedFormControl; }
  ...
  a_s3b_eq_CaractFC(index: number): UntypedFormControl { return this.a_s3b_EquipoFA.get([index, 'eq_CaractFC']) as UntypedFormControl; }
  ...
  a_s3b_an_GananciaFC(index: number): UntypedFormControl { return this.a_s3b_AntenaFA.get([index, 'an_GananciaFC']) as UntypedFormControl; }
  ...
  onChangeSatFijo(): void {
    this.a_s2_sa_FijoFC.valueChanges.subscribe((checked: boolean) => {
      if (checked && !this.a_s2_sa_MovilFC.value) {
        this.a_Seccion3aFG.enable({ emitEvent: false });
      }
      if (!checked && !this.a_s2_sa_MovilFC.value) {
        // Limpiamos la lista de Satelites
        this.a_s3a_SateliteFA.clear();
        this.a_Seccion3aFG.reset();
  ...
  onChangeSatMovil(): void {
    this.a_s2_sa_MovilFC.valueChanges.subscribe((checked: boolean) => {
      if (checked && !this.a_s2_sa_FijoFC.value) {
        this.a_Seccion3aFG.enable({ emitEvent: false });
      }
      if (!checked && !this.a_s2_sa_FijoFC.value) {
        // Limpiamos la lista de Satelites
  ...
  saveEquipo(): void {
    const equipo: Equipo = {
      ...
      caracteristica: this.eq_CaractFC.value,
    };
  ...
  editEquipo(index: number): void {
    ...
    const caracteristica = this.a_s3b_eq_CaractFC(index).value;
    ...
    this.eq_CaractFC.setValue(caracteristica);
  }

  private addEditEquipoFG(equipo: Equipo, index: number = -1): void {
    const { tipo, marca, modelo, nroSerie, caracteristica, codHomologa } = equipo;
    ...
    const newEquipoFG = this.fb.group({
      ...
      eq_CaractFC: [caracteristica, [Validators.required, noWhitespaceValidator(), Validators.maxLength(30)]],
    });
  ...
  editAntena(index: number): void {
    ...
    const ganancia = this.a_s3b_an_GananciaFC(index).value;
  ...
  private addEditAntenaFG(antena: Antena, index: number = -1): void {
    const { tipo, marca, modelo, ganancia, codHomologa } = antena;
  ...
  async cargarDatos(): Promise<void> {
    ...
    if (this.dataInput.movId > 0) {
      ...
      try {
        const dataAnexo = await this.anexoTramiteService.get<Anexo001_G28NTResponse>(this.dataInput.tramiteReqId).toPromise();
        ...
        if (this.a_Seccion2FG.enabled) {
          const { terreBanda, mariBanda, aeroBanda } = seccion2;
          this.a_s2_mo_TerrHfFC.setValue(terreBanda.hf);
          this.a_s2_mo_TerrVhfFC.setValue(terreBanda.vhf);
          this.a_s2_mo_TerrUhfFC.setValue(terreBanda.uhf);
          this.a_s2_mo_TerrShfFC.setValue(terreBanda.shf);
          this.a_s2_mo_MariHfFC.setValue(mariBanda.hf);
          this.a_s2_mo_MariVhfFC.setValue(mariBanda.vhf);
          this.a_s2_mo_MariUhfFC.setValue(mariBanda.uhf);
          this.a_s2_mo_MariShfFC.setValue(mariBanda.shf);
          this.a_s2_mo_AeroHfFC.setValue(aeroBanda.hf);
          this.a_s2_mo_AeroVhfFC.setValue(aeroBanda.vhf);
          this.a_s2_mo_AeroUhfFC.setValue(aeroBanda.uhf);
          this.a_s2_mo_AeroShfFC.setValue(aeroBanda.shf);
        ...
        if (this.a_Seccion3bFG.enabled) {
          ...
          this.a_s3b_AlturaTorFC.setValue(seccion3b.alturaTorre);
  ...
  async descargarPdf(): Promise<void> {
    ...
    try {
      ...
      const urlPdf = URL.createObjectURL(file);
      modalRef.componentInstance.pdfUrl = urlPdf;
      modalRef.componentInstance.titleModal = 'Vista Previa - Anexo 001-G/28';
    }
    catch (e) {
      console.error(e);
      this.funcionesMtcService
  ...
  async guardarAnexo(): Promise<void> {
    ...
    const dataGuardar = new Anexo001_G28NTRequest();
    // -------------------------------------
    ...
    // SECCION 2:
    const { terreBanda, mariBanda, aeroBanda } = seccion2;
    terreBanda.hf = this.a_s2_mo_TerrHfFC.value ?? false;
    terreBanda.vhf = this.a_s2_mo_TerrVhfFC.value ?? false;
    terreBanda.uhf = this.a_s2_mo_TerrUhfFC.value ?? false;
    terreBanda.shf = this.a_s2_mo_TerrShfFC.value ?? false;
    mariBanda.hf = this.a_s2_mo_MariHfFC.value ?? false;
    mariBanda.vhf = this.a_s2_mo_MariVhfFC.value ?? false;
    mariBanda.uhf = this.a_s2_mo_MariUhfFC.value ?? false;
    mariBanda.shf = this.a_s2_mo_MariShfFC.value ?? false;
    aeroBanda.hf = this.a_s2_mo_AeroHfFC.value ?? false;
    aeroBanda.vhf = this.a_s2_mo_AeroVhfFC.value ?? false;
    aeroBanda.uhf = this.a_s2_mo_AeroUhfFC.value ?? false;
    aeroBanda.shf = this.a_s2_mo_AeroShfFC.value ?? false;
    ...
    for (const controlFG of this.a_s3b_EquipoFA.controls) {
      const equipo: Equipo = {
        ...
        caracteristica: controlFG.get('eq_CaractFC').value
      };
    ...
    seccion3b.alturaTorre = this.a_s3b_AlturaTorFC.value ?? '';
