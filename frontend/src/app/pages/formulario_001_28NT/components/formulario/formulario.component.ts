...
import { UntypedFormGroup, UntypedFormBuilder, Validators, UntypedFormControl, FormArray, AbstractControlOptions } from '@angular/forms';
import { NgbActiveModal, NgbModal } from '@ng-bootstrap/ng-bootstrap';
import { Formulario001_28NTRequest } from 'src/app/core/models/Formularios/Formulario001_28NT/Formulario001_28NTRequest';
import { Formulario001_28NTResponse } from 'src/app/core/models/Formularios/Formulario001_28NT/Formulario001_28NTResponse';
import { MetaData } from 'src/app/core/models/Formularios/Formulario001_28NT/MetaData';
...
import { Formulario00128NTService } from 'src/app/core/services/formularios/formulario001-28NT.service';
...
export class FormularioComponent implements OnInit, AfterViewInit {
  ...
  txtTitulo = 'FORMULARIO 001-28 SERVICIOS PRIVADOS';
  ...
  constructor(
    ...
    private formularioService: Formulario00128NTService,
  ...
  ngOnInit(): void {
    ...
    this.formularioFG = this.fb.group({
      f_Seccion1FG: this.fb.group({
        f_s1_ModServicioFG:['', [Validators.required]],
        f_s1_ModServicioOtroFG:[''],
        /*f_s1_ModServicioFG: this.fb.group(
          {
            f_s1_ms_FijoFC: [false],
            f_s1_ms_MovilFC: [false],
            f_s1_ms_MicroondasFC: [false],
            f_s1_ms_ServicioSatFC: [false],
            f_s1_ms_CircCeTvFC: [false],
            f_s1_ms_OtrosFC: [false],
            f_s1_ms_Servicio7: [false],
            f_s1_ms_Servicio8: [false],
            f_s1_ms_Servicio9: [false],
            f_s1_ms_Servicio10: [false],
            f_s1_ms_Servicio11: [false],
            f_s1_ms_Servicio12: [false],
          }, {
            validators: [
        ...
        f_s1_EspecificaFC: [{ value: '', disabled: true }],
      }),
      ...
      f_Seccion3FG: this.fb.group({
        f_s3_PerNatFG: this.fb.group({
          f_s3_pn_TipoDocumentoFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(20)]],
          f_s3_pn_NumeroDocumentoFC: ['', [Validators.required, exactLengthValidator([8, 9])]],
          f_s3_pn_RucFC: ['', [Validators.required, exactLengthValidator([11])]],
          f_s3_pn_NombreFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(50)]],
          f_s3_pn_ApePaternoFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(50)]],
          f_s3_pn_ApeMaternoFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(50)]],
          ...
          f_s3_pn_DiscapacidadFG: this.fb.group({
            f_s3_pn_di_ResConadisFC: ['', [noWhitespaceValidator(), Validators.maxLength(50)]],
        ...
        f_s3_PerJurFG: this.fb.group({
          ...
          f_s3_pj_RepLegalFG: this.fb.group({
            ...
            f_s3_pj_rl_ApeMaternoFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(50)]],
            ...
            f_s3_pj_rl_AsientoFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(15)]],
            f_s3_pj_rl_ObjSocialFC: ['', [Validators.required, noWhitespaceValidator(), Validators.maxLength(15)]],
          }),
        }),
      }),
      // Seccion 4 pertenece a derecho de tramite
      f_Seccion5FG: this.fb.group({
        f_s5_declaracion1FC: [true],
        f_s5_declaracion2FC: [true],
      }),
    });
  }
  ...
  async ngAfterViewInit(): Promise<void> {
    ...
    switch(parseInt(this.codigoTipoSolicitudTupa)){
      case 1: 
      case 2: this.f_s1_ModServicioFG.setValue('movil'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              break;
      case 3: this.f_s1_ModServicioFG.setValue('otros'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false }); 
              this.f_s1_EspecificaFC.enable();
              this.f_s1_ModServicioOtroFG.setValue('vaf');
              break;
      case 4: this.f_s1_ModServicioFG.setValue('otros'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false }); 
              this.f_s1_EspecificaFC.enable();
              this.f_s1_ModServicioOtroFG.setValue('vam');
              break;
      case 5: this.f_s1_ModServicioFG.setValue('movil'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              break;
      case 6: this.f_s1_ModServicioFG.setValue('microondas'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              break;
      case 7: this.f_s1_ModServicioFG.setValue('fijo'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              break;
      case 8: this.f_s1_ModServicioFG.setValue('movil'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              break;
      case 9: this.f_s1_ModServicioFG.setValue('otros'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              this.f_s1_EspecificaFC.enable(); 
              this.f_s1_ModServicioOtroFG.setValue('fijoSatelite');
              this.f_s1_ModServicioOtroFG.disable({ emitEvent: false });   
              break;
      case 10: this.f_s1_ModServicioFG.setValue('fijo'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              /*this.f_s1_EspecificaFC.enable(); 
              this.f_s1_ModServicioOtroFG.setValue('fijoSatelite');
              this.f_s1_ModServicioOtroFG.disable({ emitEvent: false });   */
              break;
      case 11: this.f_s1_ModServicioFG.setValue('otros'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              this.f_s1_EspecificaFC.enable(); 
              this.f_s1_ModServicioOtroFG.setValue('radioLocalFijo');
              this.f_s1_ModServicioOtroFG.disable({ emitEvent: false });   
              break;
      case 12: this.f_s1_ModServicioFG.setValue('otros'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              this.f_s1_EspecificaFC.enable(); 
              this.f_s1_ModServicioOtroFG.setValue('radioLocalMovil');
              this.f_s1_ModServicioOtroFG.disable({ emitEvent: false }); 
              break;
      case 13: this.f_s1_ModServicioFG.setValue('otros'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              this.f_s1_EspecificaFC.enable(); 
              this.f_s1_ModServicioOtroFG.setValue('fijoSatEnAux');
              this.f_s1_ModServicioOtroFG.disable({ emitEvent: false }); 
              break;
      case 14: this.f_s1_ModServicioFG.setValue('otros'); 
              this.f_s1_ModServicioFG.disable({ emitEvent: false });  
              this.f_s1_EspecificaFC.enable(); 
              this.f_s1_ModServicioOtroFG.setValue('movilTerEnAux');
              this.f_s1_ModServicioOtroFG.disable({ emitEvent: false }); 
              break;
      case 15: this.f_s1_ModServicioFG.setValue('otros'); 
               this.f_s1_ModServicioFG.disable({ emitEvent: false }); 
               this.f_s1_EspecificaFC.enable();
              break;
    }
    /*
    if(this.f_s1_ModServicioFG.value=='otros'){
      switch(parseInt(this.f_s1_ModServicioOtroFG.value))
      {
        case 1 : 
                 break;
      }
  ...
  get f_s1_ModServicioFG(): UntypedFormControl { return this.f_Seccion1FG.get('f_s1_ModServicioFG') as UntypedFormControl; }
  get f_s1_ModServicioOtroFG(): UntypedFormControl { return this.f_Seccion1FG.get('f_s1_ModServicioOtroFG') as UntypedFormControl }
  /*get f_s1_ms_FijoFC(): FormControl { return this.f_s1_ModServicioFG.get('f_s1_ms_FijoFC') as FormControl; }
  get f_s1_ms_MovilFC(): FormControl { return this.f_s1_ModServicioFG.get('f_s1_ms_MovilFC') as FormControl; }
  get f_s1_ms_MicroondasFC(): FormControl { return this.f_s1_ModServicioFG.get('f_s1_ms_MicroondasFC') as FormControl; }
  get f_s1_ms_ServicioSatFC(): FormControl { return this.f_s1_ModServicioFG.get('f_s1_ms_ServicioSatFC') as FormControl; }
  get f_s1_ms_CircCeTvFC(): FormControl { return this.f_s1_ModServicioFG.get('f_s1_ms_CircCeTvFC') as FormControl; }
  get f_s1_ms_OtrosFC(): FormControl { return this.f_s1_ModServicioFG.get('f_s1_ms_OtrosFC') as FormControl; }*/
  get f_s1_EspecificaFC(): UntypedFormControl { return this.f_Seccion1FG.get('f_s1_EspecificaFC') as UntypedFormControl; }
  ...
  get f_s3_pn_TipoDocumentoFC(): UntypedFormControl { return this.f_s3_PerNatFG.get(['f_s3_pn_TipoDocumentoFC']) as UntypedFormControl; }
  get f_s3_pn_NumeroDocumentoFC(): UntypedFormControl { return this.f_s3_PerNatFG.get(['f_s3_pn_NumeroDocumentoFC']) as UntypedFormControl; }
  get f_s3_pn_RucFC(): UntypedFormControl { return this.f_s3_PerNatFG.get(['f_s3_pn_RucFC']) as UntypedFormControl; }
  get f_s3_pn_NombreFC(): UntypedFormControl { return this.f_s3_PerNatFG.get(['f_s3_pn_NombreFC']) as UntypedFormControl; }
  get f_s3_pn_ApePaternoFC(): UntypedFormControl { return this.f_s3_PerNatFG.get(['f_s3_pn_ApePaternoFC']) as UntypedFormControl; }
  get f_s3_pn_ApeMaternoFC(): UntypedFormControl { return this.f_s3_PerNatFG.get(['f_s3_pn_ApeMaternoFC']) as UntypedFormControl; }
  ...
  get f_s3_pn_DiscapacidadFG(): UntypedFormGroup { return this.f_s3_PerNatFG.get('f_s3_pn_DiscapacidadFG') as UntypedFormGroup; }
  get f_s3_pn_di_ResConadisFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_ResConadisFC']) as UntypedFormControl; }
  get f_s3_pn_di_VisualFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_VisualFC']) as UntypedFormControl; }
  get f_s3_pn_di_AuditivaFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_AuditivaFC']) as UntypedFormControl; }
  get f_s3_pn_di_MentalFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_MentalFC']) as UntypedFormControl; }
  get f_s3_pn_di_FisicaFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_FisicaFC']) as UntypedFormControl; }
  get f_s3_pn_di_LenguajeFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_LenguajeFC']) as UntypedFormControl; }
  get f_s3_pn_di_IntelectualFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_IntelectualFC']) as UntypedFormControl; }
  get f_s3_pn_di_MultipleFC(): UntypedFormControl { return this.f_s3_pn_DiscapacidadFG.get(['f_s3_pn_di_MultipleFC']) as UntypedFormControl; }
  ...
  get f_s3_pj_rl_ObjSocialFC(): UntypedFormControl { return this.f_s3_pj_RepLegalFG.get(['f_s3_pj_rl_ObjSocialFC']) as UntypedFormControl; }
  ...
  onClickNotificacion(): void{
    ...
    let msg = "<H3><b>MENSAJE</b></H3><br>Los actos derivados del presente procedimiento serán remitidas a su correo <b>"+correo+"</b> con el cual se afilió esta cuenta. <br>En caso sea un correo diferente, modifíquelo en la sección III del presente formulario.<br>";
    msg +="<br>Por favor, consignar un correo electrónico con dominio distinto a yahoo.com o yahoo.es";
    this.funcionesMtcService.mensajeHtml(msg);
  }

  onChangeModalidadOtros(): void {
    this.f_s1_ModServicioFG.valueChanges.subscribe((seleccionado: string) => {
      if (seleccionado=='otros') {
        this.f_s1_EspecificaFC.enable();
      } else {
        this.f_s1_EspecificaFC.reset('', { emitEvent: false });
        this.f_s1_EspecificaFC.disable();
      }
    });
    /*this.f_s1_ms_OtrosFC.valueChanges.subscribe((seleccionado: boolean) => {
      if (seleccionado) {
        this.f_s1_EspecificaFC.enable();
      } else {
        this.f_s1_EspecificaFC.reset('', { emitEvent: false });
  ...
  onChangeTipoDocumentoPerNat(): void {
    this.f_s3_pn_TipoDocumentoFC.valueChanges.subscribe((tipoDocumento: string) => {
      if (tipoDocumento?.trim() === '04') {  // Carnet de Extranjeria
        this.f_s3_pn_ApeMaternoFC.setValidators([noWhitespaceValidator(), Validators.maxLength(50)]);
        this.f_s3_pn_ApeMaternoFC.updateValueAndValidity();

        this.f_s3_pn_NumeroDocumentoFC.setValidators([Validators.required, exactLengthValidator([9])]);
        ...
        this.f_s3_pn_ApeMaternoFC.setValidators([Validators.required, noWhitespaceValidator(), Validators.maxLength(50)]);
        this.f_s3_pn_ApeMaternoFC.updateValueAndValidity();

        this.f_s3_pn_NumeroDocumentoFC.setValidators([Validators.required, exactLengthValidator([8])]);
      ...
      this.f_s3_pn_NumeroDocumentoFC.updateValueAndValidity({ emitEvent: false });
  ...
  onChangeTipoDocumentoRepLeg(): void {
    this.f_s3_pj_rl_TipoDocumentoFC.valueChanges.subscribe((tipoDocumento: string) => {
      ...
      if (tipoDocumento?.trim() === '04') {  // Carnet de Extranjeria
        this.f_s3_pj_rl_ApeMaternoFC.setValidators([noWhitespaceValidator(), Validators.maxLength(50)]);
        ...
        this.f_s3_pj_rl_ApeMaternoFC.setValidators([Validators.required, noWhitespaceValidator(), Validators.maxLength(50)]);
      ...
      this.f_s3_pj_rl_ApeMaternoFC.updateValueAndValidity({ emitEvent: false });
      this.f_s3_pj_rl_NumeroDocumentoFC.updateValueAndValidity({ emitEvent: false });
  ...
  onChangeNumeroDocumentoRepLeg(): void {
    this.f_s3_pj_rl_NumeroDocumentoFC.valueChanges.subscribe((numeroDoc: string) => {
  ...
  async buscarNumeroDocumentoRepLeg(cargarDatos = false): Promise<void> {
    ...
    if (resultado) {
      ...
      return this.funcionesMtcService.mensajeError(CONSTANTES.MensajeError.RepLegNotFound);
    }
  }
  ...
  async cargarDatos(): Promise<void> {
    ...
    if (this.dataInput != null && this.dataInput.movId > 0) {
      try {
        const dataFormulario = await this.formularioTramiteService.get<Formulario001_28NTResponse>(this.dataInput.tramiteReqId).toPromise();

        this.funcionesMtcService.ocultarCargando();
        console.log(JSON.parse(dataFormulario.metaData));
        const { seccion1, seccion2, seccion3, seccion5, seccion6 } = JSON.parse(dataFormulario.metaData) as MetaData;
        this.id = dataFormulario.formularioId;

        if (this.f_Seccion1FG.enabled) {
          /*const { fijo, movil, microondas, servicioSat, circCeTv, otros, otrosDesc } = seccion1.modalidadServicio;
          this.f_s1_ms_FijoFC.setValue(fijo);
          this.f_s1_ms_MovilFC.setValue(movil);
          this.f_s1_ms_MicroondasFC.setValue(microondas);
          this.f_s1_ms_ServicioSatFC.setValue(servicioSat);
          this.f_s1_ms_CircCeTvFC.setValue(circCeTv);
          this.f_s1_ms_OtrosFC.setValue(otros);*/
          this.f_s1_ModServicioFG.setValue(seccion1.modalidadServicio);
          this.f_s1_EspecificaFC.setValue('');
          this.f_s1_ModServicioOtroFG.setValue(seccion1.modalidadOtroServicio);
        }
        ...
        if (this.f_Seccion3FG.enabled) {
          ...
          if (this.f_s3_PerNatFG.enabled) {
            ...
            if (this.f_s3_pn_DiscapacidadFG.enabled) {
              const { resConadis, visual, auditiva, mental, fisica, lenguaje, intelectual, multiple } = perNatural.discapacidad;
          ...
          if (this.f_s3_PerJurFG.enabled) {
            ...
            this.f_s3_pj_DepartamentoFC.setValue(perJuridica.departamento.trim());
            ...
            this.f_s3_pj_rl_TipoDocumentoFC.setValue(representanteLegal.tipoDocumento.id, { emitEvent: false });
            if (representanteLegal.tipoDocumento.id === '04') {  // Carnet de Extranjeria
              this.f_s3_pj_rl_ApeMaternoFC.setValidators([noWhitespaceValidator(), Validators.maxLength(50)]);
              this.f_s3_pj_rl_NumeroDocumentoFC.setValidators([Validators.required, exactLengthValidator([9])]);
              this.showNroDocCEPerNat = true;
              this.f_s3_pj_rl_DepartamentoFC.disable({ emitEvent: false });
            ...
            this.f_s3_pj_rl_NumeroDocumentoFC.setValue(representanteLegal.numeroDocumento, { emitEvent: false });
            ...
            this.f_s3_pj_rl_ObjSocialFC.setValue(representanteLegal.objetoSocial);
      ...
      if (this.tipoSolicitante === 'PN' || this.tipoSolicitante === 'PE' || this.tipoSolicitante === 'PNR') {
      ...
      if (this.tipoSolicitante === 'PNR') {
        try {
          this.funcionesMtcService.mostrarCargando();
          const response = await this.sunatService.getDatosPrincipales(this.nroRuc).toPromise();
          this.f_s3_pn_RucFC.setValue(this.nroRuc);
          this.f_s3_pn_TelefonoFC.setValue(response.telefono.trim());
          this.f_s3_pn_CelularFC.setValue(response.celular.trim());
          this.f_s3_pn_CorreoFC.setValue(response.correo.trim());
      ...
      if (this.tipoSolicitante === 'PJ') {
        try {
          ...
          for (const repLegal of this.representanteLegal) {
            if (repLegal.nroDocumento === this.nroDocumentoLogin) {
              if (repLegal.tipoDocumento === '1') {  // DNI
                this.f_s3_pj_rl_TipoDocumentoFC.setValue('01', { emitEvent: false });
                ...
                this.f_s3_pj_rl_NumeroDocumentoFC.setValue(repLegal.nroDocumento, { emitEvent: false });
          ...
          console.error(e);
          this.funcionesMtcService.ocultarCargando().mensajeError(CONSTANTES.MensajeError.Sunat);
  ...
  guardarFormulario(): void {
    ...
    const dataGuardar = new Formulario001_28NTRequest();
    dataGuardar.id = this.id;
    dataGuardar.codigo = 'F001-28';
    dataGuardar.formularioId = 2;
    dataGuardar.codUsuario = this.nroDocumentoLogin;
    dataGuardar.tramiteReqId = this.dataInput.tramiteReqId;
    dataGuardar.estado = 1;

    const { seccion1, seccion2, seccion3, seccion5, seccion6 } = dataGuardar.metaData;

    seccion1.codigoProcedimientoTupa = this.codigoProcedimientoTupa;
    seccion1.descProcedimientoTupa = this.descProcedimientoTupa;

    seccion1.modalidadServicio = this.f_s1_ModServicioFG.value;
    seccion1.modalidadOtroServicio = this.f_s1_ModServicioOtroFG.value; 
    ...
    perNatural.tipoDocumento.documento = this.listaTiposDocumentos
      .filter((item) => item.id === this.f_s3_pn_TipoDocumentoFC.value)[0]?.documento ?? '';
    ...
    perNatural.departamento = this.ubigeoPerNatComponent?.getDepartamentoText() ?? '';
    ...
    representanteLegal.tipoDocumento.documento = this.listaTiposDocumentos
      .filter((item) => item.id === this.f_s3_pj_rl_TipoDocumentoFC.value)[0]?.documento ?? '';
    ...
    seccion6.nombre =
      this.tipoSolicitante === 'PJ'
        ? this.f_s3_pj_rl_NombreFC.value + ' ' + this.f_s3_pj_rl_ApePaternoFC.value + ' ' + this.f_s3_pj_rl_ApeMaternoFC.value
        : this.f_s3_pn_NombreFC.value + ' ' + this.f_s3_pn_ApePaternoFC.value + ' ' + this.f_s3_pn_ApeMaternoFC.value;
