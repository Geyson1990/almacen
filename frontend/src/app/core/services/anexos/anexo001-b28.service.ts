...
export class Anexo001B28Service {
  ...
  constructor(private httpClient: HttpClient) {
    this.urlApi = `${environment.baseUrlAPI}${environment.endPoint.anexos.anexo1_b28}/`;
  ...
  readPostFie(): Observable<any> {
    ...
    return this.httpClient.get(this.urlApiPdf + 'anexo001_b28', htmlOptions);
  }
