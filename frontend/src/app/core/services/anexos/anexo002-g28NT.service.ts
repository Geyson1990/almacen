...
export class Anexo002G28NTService {
  ...
  constructor(private httpClient: HttpClient) {
    this.urlApi = `${environment.baseUrlAPI}${environment.endPoint.anexos.anexo2_g28NT}/`;
  ...
  readPostFie(): Observable<any> {
    ...
    return this.httpClient.get(this.urlApiPdf + 'anexo002_g28NT', htmlOptions);
  }
