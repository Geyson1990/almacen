...
export class Anexo002G28Service {
  ...
  constructor(private httpClient: HttpClient) {
    this.urlApi = `${environment.baseUrlAPI}${environment.endPoint.anexos.anexo2_g28}/`;
  }
  ...
  readPostFie(): Observable<any> {
    ...
    return this.httpClient.get(this.urlApiPdf + 'anexo002_g28', htmlOptions);
  }
