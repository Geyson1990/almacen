...
export class Anexo001H17Service {
  ...
  constructor(private httpClient: HttpClient) {
    ...
    this.urlApi = `${environment.baseUrlAPI}${environment.endPoint.anexos.anexo1_H17}/`;
  }
  ...
  readPostFie(): Observable<any> {
    ...
    return this.httpClient.get(this.urlApiPdf + 'anexo00A_h17', htmlOptions);
  }
}
