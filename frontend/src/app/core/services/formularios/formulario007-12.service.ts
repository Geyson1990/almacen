...
export class Formulario00712Service {
  ...
  constructor(private httpClient: HttpClient) {
    this.urlApi = `${environment.baseUrlAPI}${environment.endPoint.formulario.formulario7_12}/`;
    // this.urlApiPdf = `${environment.baseUrlPdfAPI}/`;
    this.urlLocal  = `${environment.baseUrlAPI}${environment.endPoint.formulario.formulario7_12}`;
  }
  ...
  readPostFie(): Observable<any> {
    ...
    return this.httpClient.get(this.urlApiPdf + 'formulario007_12', htmlOptions);
  }
