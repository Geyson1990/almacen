...
export class Formulario00112Service {
  ...
  constructor(private httpClient: HttpClient) {
    this.urlApi = `${environment.baseUrlAPI}${environment.endPoint.formulario.formulario1_12}/`;
    // this.urlApiPdf = `${environment.baseUrlPdfAPI}/`;
    this.urlLocal  = `${environment.baseUrlAPI}${environment.endPoint.formulario.formulario1_12}`;
  }
  ...
  readPostFie(): Observable<any> {
    ...
    return this.httpClient.get(this.urlApiPdf + 'formulario001_12', htmlOptions);
  }
