...
export class Formulario001172Service {
  ...
  constructor(private httpClient: HttpClient) {
    this.urlApi = `${environment.baseUrlAPI}${environment.endPoint.formulario.formulario1_17_2}/`;
    // this.urlApiPdf = `${environment.baseUrlPdfAPI}/`;
    this.urlLocal  = `${environment.baseUrlAPI}${environment.endPoint.formulario.formulario1_17_2}`;
  }
  ...
  readPostFie(): Observable<any> {
    ...
    return this.httpClient.get(this.urlApiPdf + 'formulario001_17_2', htmlOptions);
  }
